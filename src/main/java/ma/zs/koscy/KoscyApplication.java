...
import ma.zs.koscy.zynerator.security.bean.*;
import ma.zs.koscy.zynerator.security.common.AuthoritiesConstants;
import ma.zs.koscy.zynerator.security.service.facade.*;
...
//@EnableFeignClients
public class KoscyApplication {
    public static ConfigurableApplicationContext ctx;

    public static void main(String[] args) {
        ctx=SpringApplication.run(KoscyApplication.class, args);
    }
    ...
    private static void addPermissionForAdmin(List<ModelPermission> modelPermissions) {
        modelPermissions.add(new ModelPermission("OrderKosc"));
        modelPermissions.add(new ModelPermission("ReasonKo"));
        modelPermissions.add(new ModelPermission("Technicien"));
